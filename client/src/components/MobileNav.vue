<template>
  <nav class="mobile-nav">
    ...
    <div class="managment">
      ...
      <p @click="expandSearcher">Search</p>
    ...
    <div class="searcher">
      <input type="text">
      <router-link to="/search-results">Find</router-link>
    </div>
  </nav>
</template>
...
.mobile-nav {
  ...
  .searcher{
    ...
    transition: .3s ease;
    input, a{font-size: 1.6rem; padding: .4rem .8rem;}
    input{width: 70%; border: 1px solid #555;}
    a{
      width: 30%; 
      display: block;
